  ...
  return (
    <div className="space-y-6 sm:space-y-8 max-w-7xl mx-auto pb-12 select-none">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-small text-[#64748B] mt-1">
            {isClient
              ? 'Track candidate progression and interview rounds for your organization in real-time.'
              : isEmployee
                  ...
                  <div className="rounded-2xl border border-[#E2E8F0] overflow-hidden">
                    <table className="w-full text-left text-small">
                      ...
                      <tbody className="divide-y divide-[#F1F5F9]">
                        ...
                        <tr>
                          <td className="px-4 py-2.5 font-bold text-[#64748B]">Hiring Organization</td>
              ...
              <>
                <div className="flex items-center justify-between pb-3 border-b border-[#F1F5F9]">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-h3 font-bold text-[#081226]">AI Intake</h3>
                  </div>
                ...
                {clients.length > 1 && (
                  <div>
                    <label className="text-[11px] font-bold uppercase tracking-wider text-[#64748B] block mb-1">
                      {isEmployee ? 'Assigned Service Client' : 'Managed Service Client'}
                    </label>
                    <select
                    ...
                    >
                      <option value="">Auto-Detect from Email or Select Service Client</option>
                      {clients.map(c => (
                        <option key={c.id} value={c.id}>{c.company_name}</option>
                      ))}
                    </select>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-4 rounded-2xl border border-[#E2E8F0] shadow-xs flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="relative w-full sm:w-72">
              ...
              <input
                type="text"
                placeholder="Search candidate, hiring organization, role..."
                value={search}
      ...
      >
        <div className="space-y-4">
          <p className="text-small text-[#64748B]">
            Search and select a resume belonging to <strong className="text-[#081226]">{clients.find(c => c.id === (editableForm.client_id || selectedClient))?.company_name || 'Selected Service Client'}</strong>.
          </p>
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Filter by candidate name, hiring organization, role, or resume tag (e.g. RES101)..."
