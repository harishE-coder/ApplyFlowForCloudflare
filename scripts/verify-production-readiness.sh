...
test -f "$ROOT_DIR/migrations/0001_add_r2_metadata.sql" && echo "  ✔ Migration 0001 (R2 metadata) present"
...
echo ""
echo "▶ 2. Running Backend Workers Vitest Suite (127 tests)..."
...
echo "1. Run migrations 0001 & 0002 in production Neon PostgreSQL"
echo "2. Configure Worker secrets via: wrangler secret put <NAME>"
echo "   - JWT_SECRET_KEY, DATABASE_URL, GROQ_API_KEY, VAPID_PRIVATE_KEY"
